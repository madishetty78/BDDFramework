...
public class ContactsPage extends HomePage
{
	...
	public void createNewContact(Map<String,String> map,WebDriver ldriver) throws Throwable
	{
		...
		Thread.sleep(3000);
		  logger.info("Contact Page - Start creating new Contact  " );
		...
		BrowserFactory.scrollUpBrowser(ldriver);
			...
			SaveButton.click();           
			logger.info("Contact Page - End creating new Contact  " );
	}
	...
	private void setContactField(String FieldName, String value) {
		...
		case "FirstName":
			...
			logger.info("Contact Page - FirstName Entered " );
			break;
			
		case "LastName":
			LastName.clear();
			LastName.sendKeys(value);
			logger.info("Contact Page - LastName Entered " );
			break;
		
		case "MiddleName":
			MiddleName.clear();
			MiddleName.sendKeys(value);
			logger.info("Contact Page - MiddleName Entered " );
			break;
			
		case "Company":
			Company.clear();
			Company.sendKeys(value);
			logger.info("Contact Page - Company Entered " );
			break;
			
		case "Email":
			Email.clear();
			Email.sendKeys(value);
			logger.info("Contact Page - Email Entered " );
			break;
		...
		case "Category":
			...
			for (WebElement ele :Category )
			{
				...
				{							
					ele.click();
					logger.info("Contact Page - Category Entered " );
					break;
				}
			}
			break;
		...
		case "Status":
			...
			for (WebElement ele :Status )
			{
				...
				{							
				ele.click();
				logger.info("Contact Page - Status Entered " );
				break;
				}
			}
			break;
		...
		case "Description":
			...
			logger.info("Contact Page - Description Entered " );
			break;
		}
